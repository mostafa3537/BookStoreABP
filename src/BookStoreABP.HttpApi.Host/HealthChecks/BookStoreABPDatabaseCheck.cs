...
public class BookStoreABPDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public BookStoreABPDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
